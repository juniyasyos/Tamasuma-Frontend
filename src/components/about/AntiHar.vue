    ...
    <v-container fluid class="pa-0 ma-0 mt-5">
        ...
        <v-row class="py-0 my-0">
            <v-col md="12" sm="12" cols="12" class="py-0 my-0">
                ...
                <p class="google-font" style="font-size:100%">The above is not an exhaustive list -- we do not tolerate harassment of event spanarticipants in any form. </p>
                ...
                <p class="google-font" style="font-size:100%">Harassment includes (but is not limited to):</p>
                <ul class="mt-2" style="font-size:100%">
